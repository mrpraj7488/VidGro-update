    ...
    try {
      ...
      const { error: updateError } = await supabase
        ...
        .update({
          ...
          coin_cost: coinCost,
          coin_reward: coinReward, // Dynamic reward based on duration
      ...
      Alert.alert(
        'Success',
        `Video repromoted successfully! It's now active in the queue with ${selectedViews} target views and ${coinReward} coin reward per view. New balance: 🪙${balanceResult.new_balance}`,
